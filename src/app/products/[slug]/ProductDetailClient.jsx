  ...
  return (
    <section className="border-t border-[#BCCAC1]/30 pt-12 pb-24 lg:pb-20">
      <div className="flex items-end justify-between mb-8">
        ...
        <Link href="/" className="hidden sm:flex items-center gap-1.5 hover:underline"
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10 py-8 lg:py-8">
          <div className="grid grid-cols-12 gap-16">
            ...
            <div className="col-span-5 flex flex-col gap-6">
              ...
              <div>
                ...
                {product.inStock ? (
                  <button onClick={handleAddToCart}
                    className="w-full cursor-pointer flex items-center justify-center gap-3 rounded-xl py-4 transition-all duration-200 shadow-sm"
                    style={{
                      background: added
                        ? '#085041'
              ...
              {/* Trust badges */}
              <div className="grid grid-cols-3 gap-2 border-t border-[#BCCAC1]/20 pt-6 mt-2">
                {[
