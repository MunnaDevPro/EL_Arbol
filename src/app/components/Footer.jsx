...
export default function Footer() {
  return (
    <footer className="bg-[#085041] text-white">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-10 py-10 md:py-16 pb-8 md:pb-10">

        {/* ── MOBILE layout ── */}
        <div className="md:hidden">
          {/* 2-column: Explore + Help */}
          <div className="grid grid-cols-2 gap-6 mb-8">
            <div>
              <h4 className="text-[10px] font-bold tracking-widest text-white/50 uppercase mb-4">EXPLORE</h4>
              <ul className="space-y-2.5">
                {['Shop All', 'Recipes', 'Sustainability'].map((item) => (
                  <li key={item}>
            ...
            <div>
              <h4 className="text-[10px] font-bold tracking-widest text-white/50 uppercase mb-4">HELP</h4>
              <ul className="space-y-2.5">
          ...
          <div className="space-y-3 mb-6">
            {[
              ...
              <a
                key={label}
                href="#"
                className="flex items-center gap-3 px-4 py-3 border border-white/20 rounded-lg text-sm text-white/70 hover:border-white/40 transition-colors"
              >
          ...
          <div className="border-t border-white/10 pt-5 text-center">
            <p className="text-xs text-white/40">© 2024 El Árbol Organic Markets</p>
          </div>
        </div>
