const steps = [
  {
    ...
    body: 'Fill in the short online form — business registration, monthly volume estimate, and delivery postcode. Takes under 5 minutes.',
    icon: (
  ...
  },
  {
    ...
    body: 'Our wholesale team reviews every application within 1 business day. We may call to understand your needs before approval.',
    icon: (
      <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.7" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    body: 'Your account manager walks you through pricing, the ordering platform, and sets up your first standing order if needed.',
    icon: (
      <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.7" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    body: 'Place your first order by 10 PM and receive it the following morning. Your account is fully live from this point.',
    icon: (
      <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.7" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
