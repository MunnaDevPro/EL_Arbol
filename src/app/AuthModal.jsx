    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          padding: '4px', marginBottom: '26px', gap: '2px',
        }}>
          <button
        ...
        {/* Google button */}
        <button className="auth-btn-google" style={{ marginBottom: '18px' }}>
          <GoogleIcon />
        ...
        {/* Switch mode */}
        <p style={{ fontSize: '13px', color: '#6D7A73', textAlign: 'center', margin: '18px 0 0' }}>
